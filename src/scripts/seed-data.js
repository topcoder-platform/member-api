...
const members = [
  {
    ...
    handleLower: 'upbeat',
    status: 'ACTIVE',
    email: 'upbeat@topcoder.com',
    newEmail: 'upbeat@topcoder.com',
...
{
  userId: 122,
  userHandle: 'POSTMANE2E-upbeat',
  handleLower: 'postmane2e-upbeat',
  skills: {
    286: {
      hidden: false,
      score: 1888,
...
async function seedData () {
  ...
  await helper.create('MemberEnteredSkills', memberEnteredSkills[0])
  await helper.create('MemberEnteredSkills', memberEnteredSkills[1])
}
